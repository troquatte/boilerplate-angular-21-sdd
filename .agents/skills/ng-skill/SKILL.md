...
3. Once you finish generating code, do NOT run heavy commands like `ng build` or `ng test` yourself. Instead, provide the command to the user and prompt them to run it in their terminal to verify the build.
